...
async function createSubscription(req, res, next) {
    ...
    try {
        const resp = await conn.requestPost(
            '/services/data/v53.0/composite/graph',
            graph
        );
        ...
        graphs: [
            {
                ...
                compositeRequest: [
                    {
                        method: 'POST',
                        url: '/services/data/v53.0/sobjects/Lead/',
                        referenceId: 'Lead1',
                        body: lead
                    },
                    {
                        method: 'POST',
                        url: '/services/data/v53.0/sobjects/Car__c/',
                        referenceId: 'Car1',
                        body: {
                            Name: car.name
                        }
                    ...
                    {
                        method: 'POST',
                        url: '/services/data/v53.0/sobjects/Car_Configuration__c',
                    ...
                    {
                        method: 'POST',
                        url: '/services/data/v53.0/sobjects/Car_Options__c',
